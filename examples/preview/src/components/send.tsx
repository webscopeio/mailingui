  ...
  return (
    <Popover.Root>
      <Popover.Trigger asChild>
        <button className="box-border flex h-5 w-20 items-center justify-center self-center rounded-lg border border-slate-6 p-4 text-center font-sans text-sm text-slate-11 outline-none transition duration-300 ease-in-out hover:border-slate-12 hover:text-slate-12">
          Send
        </button>
      </Popover.Trigger>
      <Popover.Anchor />
      <Popover.Portal>
        ...
        >
          ...
          <form onSubmit={onFormSubmit} className="mt-1">
            ...
            <input
              autoFocus={true}
              className="mb-3 w-full appearance-none rounded-lg border border-slate-6 bg-slate-3 px-2 py-1 text-sm text-slate-12 outline-none transition duration-300 ease-in-out placeholder:text-slate-8 focus:ring-1 focus:ring-slate-12"
